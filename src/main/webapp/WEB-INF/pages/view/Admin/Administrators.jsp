...
<link title="" href="../static/admin/aliyunAdmin/css/style.css" rel="stylesheet" type="text/css"  />
<link title="blue" href="../static/admin/aliyunAdmin/css/dermadefault.css" rel="stylesheet" type="text/css"/>
<link title="green" href="../static/admin/aliyunAdmin/css/dermagreen.css" rel="stylesheet" type="text/css" disabled="disabled"/>
<link title="orange" href="../static/admin/aliyunAdmin/css/dermaorange.css" rel="stylesheet" type="text/css" disabled="disabled"/>
<script src="../static/jQuery/jquery-1.11.1.min.js" type="text/javascript"></script>
<script src="../static/admin/aliyunAdmin/script/jquery.cookie.js" type="text/javascript"></script>
...
<nav class="nav navbar-default navbar-mystyle navbar-fixed-top">
  ...
  <div class="collapse navbar-collapse">
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown li-border"><a href="#" class="dropdown-toggle mystyle-color" data-toggle="dropdown">站点与服务<span class="caret"></span></a>
  ...
  <div class="tab right-product right-full" role="tabpanel" >
     ...
     <!-- Nav tabs -->
		<ul class="nav nav-tabs" role="tablist" id="tab-header">
			<li role="presentation" id="li11" class="active"><a href="#Section11" id="tab11" aria-controls="home" role="tab" data-toggle="tab">首页</a></li>
		</ul>
		<!-- Tab panes -->
		<div class="tab-content" >
			<div role="tabpanel" class="tab-pane active" id="Section11">
				<iframe src="<%=request.getContextPath() %>/admin/test" width="100%" height="100%" frameborder="0"></iframe>
			</div>
		</div>
