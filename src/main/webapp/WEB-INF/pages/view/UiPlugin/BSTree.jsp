...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../static/Tree/BootstarpTree/css/default.css">
						...
						<div class="modal-body">
                            ...
                            <div class="form-group">
                             <label for="inputPassword3" class="col-sm-3 control-label">角色：</label>
                                 <div class="checkbox col-sm-7" id="rolesCheckbox">
								</div>
                            </div>
                            <div class="form-group">
                                ...
                                </div><h5 class="col-sm-3" style="font-family:"微软雅黑";">越少越靠前</h5>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <label><input type="checkbox" value="select" id="editMenuSelect"  name="index_select"  ></input>设为首页</label>
                                </div>
                            </div>
                            <input type="text" class="form-control" id=parent_id  name="parent_id" style="display: none;">
                            <input type="text" class="form-control" id="editMenuId"  name="id" style="display: none;">
                        </form>
						</div>
...
<div class="col-xs-12 column">
			<div class="tabbable" id="tabs-869427">
				<ul class="nav nav-tabs">
					<li class="active">
						 <a href="#panel-627835" data-toggle="tab">Section 1</a>
					</li>
					<li>
						 <a href="#panel-885641" data-toggle="tab">Section 2</a>
					</li>
				</ul>
